...
import com.diegodev.marketplace.adapter.ImagenCarouselAdapter;
...
public class Detalle_Producto extends AppCompatActivity {
    ...
    private String vendedorIdForChat;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        vpImagenes = findViewById(R.id.vp_detalle_imagenes);
    ...
    private void mostrarDetallesProductoIndividual(@NonNull DataSnapshot snapshot) {
        ...
        if (imageUrlsSnapshot.exists()) {
            for (DataSnapshot child : imageUrlsSnapshot.getChildren()) {
                String u = child.getValue(String.class);
                if (u != null && !u.isEmpty()) urls.add(u);
            }
        }
        vpImagenes.setAdapter(new ImagenCarouselAdapter(this, urls));
    ...
    private void mostrarDetallesProducto(Producto producto) {
        ...
        java.util.List<String> urls = producto.getImageUrls();
    ...
    private void abrirChat() {
        if (vendedorIdForChat == null || vendedorIdForChat.isEmpty()) {
            Toast.makeText(this, "No se pudo identificar al vendedor para chatear.", Toast.LENGTH_SHORT).show();
            return;
        }
        Intent i = new Intent(this, ChatActivity.class);
        i.putExtra("contacto_id", vendedorIdForChat);
        startActivity(i);
    }
    /**
