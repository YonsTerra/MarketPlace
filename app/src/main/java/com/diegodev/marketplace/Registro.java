...
public class Registro extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ccpSelectorCod = findViewById(R.id.ccp_selector_cod_registro);
    ...
    private void guardarDatosUsuario(String uid, String nombre, String email) {
        ...
        String codigo = ccpSelectorCod != null ? ccpSelectorCod.getSelectedCountryCode() : null;
        String telefono = etTelefono != null ? etTelefono.getText().toString().trim() : null;
        if (codigo != null && !codigo.isEmpty() && telefono != null && !telefono.isEmpty()) {
            userData.put("codigoTelefono", codigo);
    ...
    private boolean validarCampos() {
        ...
        if (!TextUtils.isEmpty(telefono)) {
            if (!telefono.matches("^[0-9]{6,15}$")) {
                if (etTelefono != null) etTelefono.setError("Ingrese un teléfono válido (solo dígitos).");
                valido = false;
            } else {
